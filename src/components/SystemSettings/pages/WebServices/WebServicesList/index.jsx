...
// components
import { WebserviceListTable, CreateWebserviceModal } from '../../../components';
...
function WebServicesList() {
  ...
  return (
    <div className={classes.root}>
      ...
      <CreateWebserviceModal open={openModal} onClose={() => setOpenModal(false)} />
    </div>
  );
}
